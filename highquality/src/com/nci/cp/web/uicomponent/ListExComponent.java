 ...
 * @date    2011-2-22
 */
public class ListExComponent extends AbstractUIComponent {
	...
	public ListExComponent(String id,String name,String cssstyle,List headerlist,List tableModel) {
		super();
	...
	private String makeRow(List list,String tag,int order) {
		...
		if (HEADER_TAG.equals(tag)) {
			...
			rowsb.append("<input  name=\"c"+name+order+"\" type=\"checkbox\" value=\"\"/>");
			rowsb.append("</td>");
		}
