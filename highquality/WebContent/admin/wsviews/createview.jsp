...
<HTML>
 <HEAD> 
  ...
  function submit(formid)  {
	...
	function Ajax(url,action,callback) {
	  this.xmlhttp;
	  this.url=url;
	  this.action=action;
...
<div class="ToolBar">
        <span class="ToolBarButton">                  
            	<a class="Btn_Save" id="Btn_Save" onmouseover='javaScript:this.className="Btn_Save_Over"' onmouseout='javaScript:this.className="Btn_Save"' onclick="javascript:submit('createviewform');"></a>            
...
<form method="post" id="createviewform" name="createviewform" action="saveView.action">
<div class="EditDivBody">		
        ...
        <caption>视图信息</caption>
                ...
                <tr>
                    ...
                    <td class="EditRow" style="width:30%;"><input id="viewVo.name" name="viewVo.name" class="EditInput" type="text"  maxlength="100"   style="width:100%;" /></td>
                	<td class="EditHead" style="width:20%;">视图标识</td>
                    <td class="EditRow" style="width:30%;"><input id="viewVo.viewId" name="viewVo.viewId" class="EditInput" type="text"  maxlength="100"  style="width:100%;" /></td>
                </tr>       
                <tr>
                    <td class="EditHead">备&nbsp; &nbsp; 注</td>
                    <td class="EditRow" style="padding-top:2px;padding-bottom:2px;" colspan="3"><textarea id="viewVo.mark" name="ftvo.mark" class="EditArea" cols="2" rows="2" style="width:98.1%" ></textarea></td>
                </tr>    
